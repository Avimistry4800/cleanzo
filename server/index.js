...
client.connect((err) => {
  console.log(err);
  const serviceCollection = client.db("cleanzo").collection("service");
  const orderCollection = client.db("cleanzo").collection("orders");
  const reviewCollection = client.db("cleanzo").collection("reviews");
